        ...
        <div class="row">
          ...
          <div class="col-sm-9">
            <div class="row">
              ...
              <div class="col-sm-3 mb-3">
                <div class="card">
                  <img class="image-fit" src="https://fakestoreapi.com/img/71-3HjGNDUL._AC_SY879._SX._UX._SY._UY_.jpg"
                    class="card-img-top" alt="image">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
              ...
              <div class="col-sm-3 mb-3">
                <div class="card">
                  <img class="image-fit" src="https://fakestoreapi.com/img/71li-ujtlUL._AC_UX679_.jpg"
                    class="card-img-top" alt="image">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
              ...
              <div class="col-sm-3 mb-3">
                <div class="card">
                  <img class="image-fit" src="https://fakestoreapi.com/img/51eg55uWmdL._AC_UX679_.jpg"
                    class="card-img-top" alt="image">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
              ...
              <div class="col-sm-3 mb-3">
                <div class="card">
                  <img class="image-fit" src="https://api.lorem.space/image/watch?w=640&h=480&r=3742"
                    class="card-img-top" alt="image">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
              ...
              <div class="col-sm-3 mb-3">
                <div class="card">
                  <img class="image-fit" src="https://api.lorem.space/image/fashion?w=640&h=480&r=7891"
                    class="card-img-top" alt="image">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
              ...
              <div class="col-sm-3 mb-3">
                <div class="card">
                  <img class="image-fit" src="https://api.lorem.space/image/fashion?w=640&h=480&r=687"
                    class="card-img-top" alt="image">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
              ...
              <div class="col-sm-3 mb-3">
                <div class="card">
                  <img class="image-fit" src="https://api.lorem.space/image?w=640&h=480&r=5844" class="card-img-top"
                    alt="image">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
